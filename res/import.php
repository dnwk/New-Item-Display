<?php
/*
* This file will pull Alma analytics for new book purchased in last 30 days and insert into MySQL database
*/
require_once "conn.php";
//when loading new Alma analytics, delete existing data.
...
//process XML from Alma analytics. Customize it if Analytics changed.
